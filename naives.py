...
print ( "AUC Score (Area Under Curve) : ", roc_auc_score(y_test, predicted_class_probs[:,1]) )

fpr, tpr, _ = roc_curve(y_test, predicted_class_probs[:,1])
